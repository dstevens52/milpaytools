...
export const PAY_PAGE_RANKS: PayPageRank[] = [
  ...
  },
  {
    ...
    exampleDependents: true,
    contextCopy: [
      'E-7 is the senior NCO threshold — Sergeant First Class in the Army, Gunnery Sergeant in the Marine Corps, Master Sergeant in the Air Force and Space Force, and Chief Petty Officer in the Navy, where the grade carries its own induction tradition and a distinct uniform. E-7s typically serve as platoon sergeants, flight chiefs, or leading chiefs: the experience layer commanders lean on.',
  ...
  },
  {
    ...
    exampleDependents: true,
    contextCopy: [
      'O-4 is the start of the field grades — Major in the Army, Marine Corps, Air Force, and Space Force, and Lieutenant Commander in the Navy. The work shifts from leading at the line to running staffs, plans, and programs, usually alongside intermediate professional military education.',
  ...
  },
  {
    ...
    exampleDependents: true,
    contextCopy: [
      'O-5 is the command grade — Lieutenant Colonel in the Army, Marine Corps, Air Force, and Space Force, and Commander in the Navy. Battalion and squadron command, ship command, and senior staff leadership sit at this level, and selection for command is a separate competition beyond the promotion itself.',
