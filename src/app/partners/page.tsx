...
export const metadata: Metadata = {
  title: { absolute: 'For Partners — MilPayTools' },
  description:
    'Free military finance tools built on official DoD and VA data. No account, no ads, nothing to sell. Safe to share with any service member, veteran, or military family.',
  alternates: { canonical: 'https://www.milpaytools.com/partners' },
  openGraph: {
    ...
    <>
      ...
      <section className="bg-slate-900 py-16 sm:py-24 px-4">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="text-lg sm:text-xl text-white/70 leading-relaxed max-w-2xl mx-auto mb-5">
            Your audience has real military money questions — what their pay is actually worth, what
            BAH covers, whether their VA decision is right, what transition actually costs. These
            tools answer those questions using official DoD and VA data, with no account required,
            no ads, and nothing to sell. Free to share, every time.
          </p>
          <p className="text-base sm:text-lg text-white font-semibold leading-relaxed max-w-2xl mx-auto">
            Most service members don&apos;t know what their compensation is really worth. These tools
            show them — and the number is almost always higher than they expected.
          </p>
        </div>
      </section>
      ...
      <section className="bg-zinc-50 border-b border-zinc-200 py-14 sm:py-18 px-4">
        <div className="mx-auto max-w-3xl">
          ...
          {/* Shareable link */}
          <div className="rounded-lg bg-white border border-zinc-200 px-5 py-4 mb-8">
      ...
      <section className="bg-white border-b border-zinc-200 py-10 px-4">
        <div className="mx-auto max-w-3xl">
          <Link
            ...
            className="text-sm font-semibold text-red-700 hover:text-red-800 transition-colors"
          >
            See all calculators and guides →
          </Link>
        </div>
      </section>
