      ...
      <div className="hidden md:block border-b border-zinc-200 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5">
          <div className="flex items-center gap-5">
            {[
              { n: 1, title: 'Enter your pay grade and drill schedule' },
              { n: 2, title: 'See annual drill pay and AT earnings' },
              { n: 3, title: 'Add TRICARE Reserve Select to see full compensation value' },
            ].map(({ n, title }, i, arr) => (
              <>
