...
const FAQS = [
  {
    ...
    answer: 'The IRRRL (Interest Rate Reduction Refinance Loan) is a VA refinance program for existing VA loan borrowers. VA generally does not require a full appraisal or income underwriting for an IRRRL, although lenders may apply overlays or request additional documentation. The funding fee is 0.5% — much lower than purchase loans — and disability-exempt veterans are not subject to the fee. The refinance must result in a lower interest rate, lower payment, or a transition from an adjustable-rate to a fixed-rate mortgage. It can only refinance an existing VA loan.',
  },
  {
