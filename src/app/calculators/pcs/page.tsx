      ...
      <div className="hidden md:block border-b border-zinc-200 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5">
          <div className="flex items-center gap-5">
            {[
              { n: 1, title: 'Enter your origin and destination' },
              { n: 2, title: 'See your full PCS entitlements (DLA, MALT, per diem, TLE)' },
              { n: 3, title: 'Compare government move vs. PPM/DITY' },
            ].map(({ n, title }, i, arr) => (
              <>
