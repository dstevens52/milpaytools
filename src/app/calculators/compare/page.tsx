      ...
      <div className="bg-white border-b border-zinc-200">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-4 md:py-8">
          ...
          <div className="mt-3 hidden md:flex flex-wrap gap-3">
            {[
              'Side-by-side BAH + COLA + tax',
              'Two duty stations compared',
      ...
      <div className="hidden md:block border-b border-zinc-200 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5">
          <div className="flex items-center gap-5">
            {[
              { n: 1, title: 'Enter two duty stations and your rank' },
              { n: 2, title: 'See side-by-side BAH, COLA, and tax differences' },
              { n: 3, title: 'Make an informed PCS preference decision' },
            ].map(({ n, title }, i, arr) => (
              <>
