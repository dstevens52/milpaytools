      ...
      <div className="hidden md:block border-b border-zinc-200 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5">
          <div className="flex items-center gap-5">
            {[
              { n: 1, title: 'Enter both service members\' duty stations and ranks' },
              { n: 2, title: 'See who should claim dependents for maximum BAH' },
              { n: 3, title: 'Compare all housing scenarios' },
            ].map(({ n, title }, i, arr) => (
              <>
