...
If you're actively separating and need the exact conversion timeline — which days your free coverage ends, when the guaranteed VGLI window closes, and what happens if you miss it — see [SGLI to VGLI: The 240-Day Window You Can't Miss After Separation](/blog/sgli-to-vgli-conversion-after-separation).
