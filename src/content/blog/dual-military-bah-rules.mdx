...
Only one member can claim the with-dependents rate — whichever member the children are designated to as dependents in DEERS. The choice is not arbitrary: consider which member has the larger gap between their with-dependents and without-dependents BAH rates for your specific duty station. That gap varies by rank and location in ways that cannot be predicted without checking the 2026 DTMO rate tables.

The math doesn't always favor the higher-ranking member. At some stations, a junior enlisted member's with/without gap exceeds an officer's gap. Getting this wrong costs money every month with no mechanism to recover it retroactively.
