...
Each member's BAH is based on their own duty station ZIP code and pay grade. If one member is at [Fort Bragg](/bah/fort-bragg) and the other is at JBLM, each receives BAH for their respective installation. The member with children designated in DEERS receives the with-dependents rate for their station; the other receives the without-dependents rate for theirs.
