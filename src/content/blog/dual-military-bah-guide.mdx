...
When two active-duty members are stationed at the same duty station, only one can receive the with-dependents BAH rate — and the correct choice is not automatically the higher-ranking member. The right choice is whichever member has the larger gap between their with-dependents and without-dependents rate at that specific installation, which varies by rank and location in ways that cannot be predicted without checking the actual 2026 DTMO rate tables. Getting this wrong produces a permanent monthly loss that most dual-military couples never revisit after the initial assignment.
...
An O-3 and an E-5 are co-located in [San Diego](/bah/naval-station-san-diego). They have a child. When the baby arrived, they did what everyone told them to do: put the dependent under the O-3. Higher rank, higher BAH, seems obvious.
...
**The E-5 claiming produces $558/month more — $6,696/year.** Because the E-5's premium at this location is so much larger than the O-3's, putting the dependent designation on the junior member produces the highest household total.
...
## How does BAH work for dual military couples stationed at different locations?

When one member receives orders to San Diego and the other to [Norfolk](/bah/naval-station-norfolk), the claiming question changes entirely. Dependent assignment is no longer a financial optimization — it's a policy determination.
...
For more on the broader financial picture — two TSP accounts, two pensions, childcare costs, and what dual military retirement actually looks like — see [Dual Military Financial Strategies: Making Two Incomes Work](/blog/dual-military-financial-strategies). For a quick overview of the core dual-military BAH rules, see [Do Both Military Spouses Get BAH? Dual Military Housing Rules](/blog/dual-military-bah-rules).
