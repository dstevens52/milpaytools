...
TSP offers five individual funds — G (government bonds), F (fixed-income index), C (S&P 500 equivalent), S (small-cap index), and I (international index) — plus Lifecycle funds that automatically blend them based on a target retirement date. New BRS enrollees default to an age-appropriate Lifecycle fund, which is a reasonable starting point. The most important thing to understand is the G Fund: it carries essentially no risk of loss but has historically earned modest returns that may barely keep pace with inflation, while the C Fund has significantly higher historical long-term average returns with more short-term volatility.
...
Yes — substantially. An E-3 at age 20 who invests $10,000 in the G Fund versus the C Fund could see a six-figure difference by age 60, based on historical return differences, even before any additional contributions. TSP's expense ratios are among the lowest of any workplace retirement plan — typically under 0.06% — so fund allocation, rather than fees, is the primary variable in where your balance ends up.

That's the practical reason the default L Fund matters: it keeps you out of an all-G-Fund allocation that historically hasn't kept pace over a long career, without requiring you to pick funds yourself.

## How to check and change your TSP allocation

It takes about 5 minutes.

One thing that trips people up: changing your **fund allocation** happens at TSP.gov, but changing your **contribution rate** (the percentage of base pay you put in) happens in myPay — they are two separate systems.
