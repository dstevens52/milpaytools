...
The core difference between BRS and High-3 is the pension multiplier: 2.5% per year of service under High-3 versus 2.0% per year under BRS, producing 50% of High-3 base pay at 20 years versus 40% under BRS. BRS partially offsets the smaller pension with government TSP matching of up to 5% of base pay and continuation pay at 8–12 years of service. Service members who entered after January 1, 2018 are in BRS automatically; understanding which system you are in determines how the retirement math works and what breakeven assumptions apply.
...
<QuickAnswer>
  ...
  <QAItem>If you serve fewer than 20 years: BRS is generally more advantageous — you keep TSP matching even if you never vest in a pension</QAItem>
  <QAItem>If you plan to serve 20+ years: High-3 pension value may be higher in total pension dollars, depending on contribution history and investment returns</QAItem>
</QuickAnswer>
...
## How much less is the BRS pension compared to High-3 at 20 years?
...
Using 2026 DFAS pay table data, an [E-7](/pay/e7) retiring at 20 years of service would have a High-3 average of approximately **$6,141/month** (based on the last three years of pay: $6,000.90/month at over 16 years, $6,177.30 at over 18, and $6,245.70 at over 20).

| System | Formula | Monthly Pension | Annual Pension |
|--------|---------|----------------|---------------|
| High-3 | 50% × $6,141 | **$3,070.65** | **$36,848** |
| BRS | 40% × $6,141 | **$2,456.52** | **$29,478** |
...
## What TSP matching do BRS members receive that High-3 members don't?
...
For an E-5 at the beginning of year 3 ($3,775.80/month base pay) contributing 5%:
...
And that's before counting the member's own contributions — all of which add up to a [total compensation picture](/calculators/total-compensation) most service members underestimate. If you're new to TSP and want to understand what your default settings are actually doing, see [TSP for Beginners: What Happens If You Never Change Your Settings](/blog/tsp-for-beginners-what-happens-if-you-do-nothing).
...
## What is Continuation Pay and how much do BRS members receive?
...
**Example: E-7 at 10 years ($5,300.40/month base pay):**
- Minimum continuation pay: 2.5 × $5,300.40 = **$13,251.00**
- Higher multiples for critical career fields can push this to $25,000–$50,000+

This bonus comes with a service obligation (typically 4 years), but for members who plan to stay past 12 years anyway, it's additional DoD compensation with no High-3 equivalent.

## Does BRS or High-3 produce more lifetime retirement value?
...
**If you serve exactly 20 years**, High-3 typically wins in total lifetime pension value, assuming average longevity. The $614/month pension gap compounds over decades of retirement. At 30 years of retirement, that gap alone is $221,040 in additional pension income for High-3.
...
If you're in the 10–19 year zone and actively weighing whether to stay, see [the full financial math behind the stay-to-20 decision](/blog/should-i-stay-to-20-years-military) — including what the pension is worth in lifetime dollars and what civilian compensation would need to look like to match it. For a quick-answer overview of the core BRS vs High-3 difference, see [What Is the Difference Between BRS and High-3 Military Retirement?](/blog/brs-vs-high-3-difference).
