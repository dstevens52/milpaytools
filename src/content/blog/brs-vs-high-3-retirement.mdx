...
And that's before counting the member's own contributions — all of which add up to a [total compensation picture](/calculators/total-compensation) most service members underestimate.
