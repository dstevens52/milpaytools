...
SGLI coverage ends 120 days after separation, and the VGLI conversion window — which requires no health exam — closes at 240 days post-separation. After Day 240, a medical exam is required to convert; after 1 year and 120 days, VGLI is no longer available at any price. VGLI premiums start low but escalate steeply with age — reaching $270/month by 50–54 — which is why purchasing competitive private term life insurance while still on active duty, before health issues develop, is generally the more cost-effective long-term strategy.
