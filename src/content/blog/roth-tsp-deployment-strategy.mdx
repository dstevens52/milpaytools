...
For a full breakdown of every pay component that changes during a deployment — HFP/IDP, FSA, HDP, SDP, and how CZTE works mechanically — see [Deployment Pay Explained: Every Dollar You Earn Downrange](/blog/deployment-pay-explained).
