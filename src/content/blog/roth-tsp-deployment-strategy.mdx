...
For a regular Roth TSP contribution made at a non-combat-zone assignment, only Advantage 2 applies — you still paid 22% (or whatever your bracket) before contributing. In a combat zone, both advantages apply simultaneously. The result is money that is genuinely, completely, never-taxed at any point.
...
The combat zone Roth TSP strategy is one of the clearest financial advantages available to service members that has no civilian equivalent. It combines two separate tax-free mechanisms that cannot coexist outside of a CZTE assignment.
...
The action: before your next deployment, log into MyPay and set a Roth TSP contribution election. If you contribute nothing else for your entire military career, contributing as much as possible during a combat zone deployment is the single highest-return financial move available in the military compensation system.
