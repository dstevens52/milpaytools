...
**Both sides of a paired joint can matter more than their face value.** The bilateral factor applies only when both sides of a paired arm or leg are rated above 0%, so a second-side rating can carry the combined value across a tier boundary that a single side would not reach.
