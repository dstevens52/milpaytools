...
VA disability ratings are not added together — the combined ratings formula applies each additional percentage to the remaining healthy capacity, not the original 100%. That is why 50% + 30% + 20% produces a 70% combined rating under VA math, not 100%. Understanding where a combined rating sits in the compensation table before filing additional claims helps identify which conditions would actually move it to the next tier — a distinction that can mean several hundred dollars per month in the difference.
