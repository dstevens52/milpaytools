---
title: "SCRA and MLA: Financial Protections Every New Service Member Should Know | 2026"
...
You give written notice to the landlord with a copy of your orders. Termination is effective 30 days after the next rent payment date following notice. You cannot be charged early termination fees under SCRA if you follow the proper notice procedure.

This also covers month-to-month leases and applies to cell phone contracts for deployments or PCS — the Wireless Act amendment lets you terminate without penalty when deployed outside the carrier's coverage area or receiving PCS orders.
...
MLA protections apply from the moment you're on active duty. There's no waiting period. And lenders are legally required to check the DoD Military Lending Act Database before extending covered credit — they're supposed to know you're a service member and apply the cap without you having to ask.
...
<CalculatorCallout calculator="total-compensation" text="See your full military compensation picture — base pay, allowances, tax advantages, and healthcare value — so you understand exactly what your service is worth." />
