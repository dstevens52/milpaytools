...
**Treat all COLA as invisible.** Build your monthly budget on base pay + BAH/OHA — [look up your exact BAH rate by ZIP code](/bah) to anchor that number before your orders are issued. Automate a transfer of OCONUS (or CONUS) COLA to savings or investment accounts on payday. Live as if the allowance doesn't exist in your checking account.
