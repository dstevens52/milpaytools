...
Military retirement pays an immediate monthly pension beginning the day a service member retires — typically around age 38–40 for a 20-year member — not a 401(k) balance drawn down at 65. Under High-3, retirement pay equals 2.5% multiplied by years of service multiplied by the average of the three highest-pay years, producing 50% of that average at exactly 20 years; under BRS, the multiplier is 2.0%, partially offset by government TSP matching of up to 5% of base pay during service. There is no partial vesting before 20 years under regular longevity retirement, making the military pension structurally different from virtually every civilian retirement plan.

<QuickAnswer>
  <QAItem>Regular active-duty longevity retirement generally requires 20 years of qualifying service — there is no partial longevity pension at 10, 12, or 15 years. Separate rules apply for medical disability retirement and Guard/Reserve retirement.</QAItem>
...
For junior enlisted in lower tax brackets, Roth TSP is often worth considering — pay a small tax rate now to build a completely tax-free pool that compounds for decades. See [The Roth TSP Advantage Nobody Explains to Junior Enlisted](/blog/roth-tsp-advantage-junior-enlisted) for the math.
