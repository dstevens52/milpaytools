...
date: "2026-04-17"
description: "Most military retirees with VA disability ratings don't realize they have a choice between CRDP and CRSC — and picking wrong can cost hundreds per month. Here's the math on both."
...
<QuickAnswer>
  ...
  <QAItem>You cannot receive both — you receive whichever is higher automatically, or you can elect CRSC if eligible and it pays more after taxes</QAItem>
...
**What about ratings below 50%?** CRDP phases in for ratings below 50% — you receive partial restoration, not full concurrent receipt. Retirees with a 40% VA rating receive some offset relief but not complete restoration. Only 50%+ ratings get full concurrent receipt under CRDP.
...
The takeaway: **if most or all of your VA rating is combat-related, CRSC is often beneficial**. If a significant portion of your rating comes from non-combat conditions, CRDP will often produce more after-tax income.
...
Individual tax situations vary — consult a tax professional for personalized advice before making a CRDP vs. CRSC election.
...
**CRDP is not available to Chapter 61 medical retirees.** CRDP requires 20 or more qualifying years of service, which most medical retirees under Chapter 61 have not reached.
...
3. **Apply for CRSC through your branch if it looks favorable.** Even if you're already receiving CRDP, you can apply for CRSC and elect it if it pays more after taxes. The election can be changed annually.
