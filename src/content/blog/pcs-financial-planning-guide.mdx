...
A PCS involves 8–10 separate financial entitlements — DLA, MALT mileage, per diem, TLE, household goods weight, and more — each with its own deadline, calculation method, and eligibility rules. Filing the travel voucher within 60 days of reporting, understanding PPM versus government move math, and timing a lease exit to avoid overlap can make a $3,000–$5,000 difference in the final financial outcome. Most of the money left on the table is not recoverable after the move has started — the planning window is before orders are cut.

<QuickAnswer>
  <QAItem>A PCS involves 8–10 separate financial events, each with its own deadlines and eligibility rules</QAItem>
  <QAItem>DLA, MALT mileage, per diem, TLE, and PPM net proceeds all have different calculation methods</QAItem>
...
<CalculatorCallout calculator="pcs" text="Estimate your total PCS entitlements — DLA, mileage, per diem, TLE, and PPM net proceeds — before your orders are finalized." />
...
- Compare the two stations side-by-side with the [Compare Your PCS Move calculator](/calculators/compare)
...
**If you're considering buying at the new duty station:** Start the VA loan pre-approval process now. Pre-approval takes 2–4 weeks; finding and closing on a home typically takes 30–90 days in a normal market. Starting 6 months out gives you time to close before you report. For a full explanation of how the VA loan benefit works — eligibility, the funding fee, and entitlement — see [VA Home Loans Explained: What Every Service Member Should Know](/blog/va-home-loan-basics).
...
If PPM produces net proceeds (reimbursement > actual costs by $2,000+), request the 60% advance at TMO before you move.
...
|------|-------------------|-----------------|
| E-1 – E-4 | $1,871 – $2,389 | $3,548 |
| E-5 – E-9 | $2,389 – $3,148 | $3,548 – $4,150 |
| O-1 – O-3 | $2,274 – $3,404 | $3,085 – $4,042 |
| O-4 – O-6 | $4,248 – $4,759 | $4,885 – $5,750 |
...
The difference between the government's estimated cost and your actual expenses is your net proceeds. These net proceeds are taxable income.
...
## What PCS financial mistakes cost service members money they could have kept?
...
## What is the cumulative financial value of well-executed PCS moves over a military career?

A service member with 20 years will execute 6–8 PCS moves. Over that career, the cumulative value of well-executed PCS entitlements — captured DLA, accurate MALT, properly filed TLE, net-positive PPM moves where applicable — can easily total $30,000–$50,000 in additional payments that many members partially or fully miss.

The documentation habits matter: keep every receipt, file vouchers promptly, and use your TMO and finance office early rather than figuring it out after the fact. For a quick overview of what typically comes out of pocket during a PCS, see [How Much Does a PCS Move Cost Out of Pocket?](/blog/pcs-out-of-pocket-costs).
