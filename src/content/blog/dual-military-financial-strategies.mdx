...
## How do dual military couples maximize two TSP accounts?
...
3. If deployed to a combat zone, the contribution limit for the deployed member rises to $72,000 (total additions limit) — coordinate who maximizes this
