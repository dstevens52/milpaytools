...
Dual active-duty couples receive two salaries, two TSP accounts with combined contribution room of up to $49,000 per year, and the potential for two military pensions — but BAH co-location rules, coordinated orders, and childcare costs require deliberate management. When co-located, only one member receives the with-dependents BAH rate; when stationed separately, both may receive their own BAH, which can significantly exceed combined housing costs. The upside is substantial, but it requires actively managing dependent designation, TSP elections, and joint-spouse assignment preferences at every PCS cycle.
...
<QuickAnswer>
  ...
  <QAItem>Two TSP accounts mean double the contribution limits — up to $49,000/year combined in 2026</QAItem>
...
## What does the financial picture look like for dual military couples?
...
This guide focuses on the financial mechanics — how the money works, how to make the most of it, and what the retirement picture looks like.

## How does BAH work for dual military couples at the same duty station?
...
## How do dual military couples make the most of two TSP accounts?
...
Under the Blended Retirement System (BRS), the DoD contributes 1% of base pay automatically and matches member contributions up to 4%. On two salaries, that's two streams of government matching that compound over a career.

**TSP optimization for dual military couples:**

1. Both members contribute at least 5% to capture full matching (under BRS)
2. Consider increasing traditional TSP contributions if you're in a high combined tax bracket now; Roth TSP if you expect higher rates in retirement
3. If deployed to a combat zone, the total annual additions limit for the deployed member rises to $72,000 — though Roth TSP contributions remain capped at $24,500; excess tax-exempt contributions above that go into the traditional tax-exempt portion of TSP. Coordinate to maximize the deployed member's TSP contributions during the window.
...
## What does dual military retirement look like with two pensions?
...
|--|--|--|--|
| High-3 base pay | ~$11,600/month | ~$6,700/month | |
| Pension (50% High-3) | ~$5,800/month | ~$3,350/month | **$9,150/month** |
| Annual pension | ~$69,600 | ~$40,200 | **$109,800/year** |

This $109,800/year is partially tax-advantaged ([VA disability compensation](/calculators/va-disability) is not taxed; pension is regular income but at lower effective rates post-career). Both pensions also include annual COLA adjustments tied to inflation.
...
## How do dual military couples manage childcare costs?
...
## How do joint-spouse assignment requests work and what are the financial implications?
...
## Should dual military couples file taxes jointly or separately?
