...
When both members are stationed at or near the same installation, the BAH rules change:

- The **senior member** (higher grade) receives BAH at the with-dependents rate
- The **junior member** receives BAH at the without-dependents rate

The net effect: you lose one with-dependents BAH rate and replace it with a without-dependents rate. The difference depends on the duty station, but it's typically $300–$600/month less than receiving two with-dependents rates.

This has a practical implication for housing decisions: when co-located, your combined housing allowance is somewhat lower than it would be if separated. Budget accordingly.
...
In 2026, the TSP contribution limit is **$23,000/year** per member ($30,500 for members age 50+). A dual military couple can contribute a combined **$46,000/year** to tax-advantaged retirement accounts before touching IRAs or other vehicles.
