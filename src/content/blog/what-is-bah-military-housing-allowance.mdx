...
date: "2026-05-27"
description: "BAH (Basic Allowance for Housing) is the tax-free monthly payment that funds your off-post housing. Here's exactly how it's calculated, what affects it, and what it's actually worth."
...
<QuickAnswer>
  ...
  <QAItem>BAH is designed to cover approximately 95% of local housing costs for your grade — you keep any difference if you find cheaper housing</QAItem>
  ...
  <QAItem>338 military housing areas (MHAs) covering 40,959 ZIP codes — your duty station ZIP determines which MHA you're in</QAItem>
</QuickAnswer>
...
The Defense Travel Management Office (DTMO) surveys local rental markets annually to determine what it costs to rent housing appropriate to each pay grade in each area. The goal is to cover approximately the **95th percentile of local rental costs** — meaning BAH should be enough to rent housing in the mid-to-upper range of the local market for your grade.
...
The 338 military housing areas (MHAs) don't always align with city or county boundaries — they're defined by where military members tend to live relative to their installations. Fort Bragg covers ZIP codes throughout the Fayetteville area; Camp Pendleton draws on the broader San Diego metro MHA.
...
Conversely, if housing in your area costs more than your BAH, you pay the difference out of pocket. BAH doesn't guarantee full coverage — it covers a defined percentile of the local market.
...
BAH covers all 50 states, Washington D.C., and certain territories. The 40,959 ZIP codes are grouped into 338 military housing areas.
...
**Reserve/Guard on short orders:** Guard and Reserve members typically receive BAH only on active duty orders of more than 30 days. Short periods of active duty (drill weekends, annual training) don't trigger BAH entitlement.
