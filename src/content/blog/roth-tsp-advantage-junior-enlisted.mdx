...
<KeyFact>$300/month in Roth TSP at age 20, earning 10% average annual return (consistent with the C Fund's long-term historical performance), grows to approximately $1.9 million by age 60. Qualified withdrawals are tax-free — subject to TSP withdrawal rules including the age 59½ requirement for penalty-free distributions.</KeyFact>
...
## What happens to your BRS matching if you front-load your TSP contributions?
...
New to TSP entirely and not sure what fund your contributions are going into? See [TSP for Beginners: What Happens If You Never Change Your Settings](/blog/tsp-for-beginners-what-happens-if-you-do-nothing).
