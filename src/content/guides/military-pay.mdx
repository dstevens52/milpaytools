...
**How it's calculated:** The Defense Travel Management Office (DTMO) surveys local rental markets each year and sets BAH rates to cover approximately 95% of median local housing costs for your pay grade. This means a sergeant in San Diego and a sergeant in rural Georgia receive completely different BAH rates — because local housing markets are completely different.
...
**Combat zone tax exclusion:** Service members deployed to a designated combat zone may exclude their entire base pay (plus any other military pay) from federal income tax while in the zone. For a deployed E-5, that's $3,717/month in otherwise-taxable income going completely untaxed. This exclusion dramatically increases the effective value of a deployment. See [how deployment pay works](/blog/military-tax-advantages) for a full breakdown.
