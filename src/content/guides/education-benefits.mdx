...
**Tuition:** Up to the highest in-state public school tuition rate for in-state programs. For out-of-state public schools or private schools, there's a separate maximum cap ($27,660.35/year for 2026 at private schools under the Yellow Ribbon program at 100% participating schools).

**Monthly Housing Allowance (MHA):** The single biggest financial variable in GI Bill planning. MHA is calculated at the BAH rate for an E-5 with dependents at the zip code of the school's primary campus. It's paid at the full monthly rate while enrolled full-time, half for half-time enrollment, and zero for online-only programs.

**Book and supply stipend:** Up to $1,000 per academic year.

**Entitlement:** 36 months of benefits, which typically covers 4 academic years at a standard semester pace. Benefits expire 15 years from your date of discharge (for post-9/11 service members; this deadline was eliminated for those who separated after January 1, 2013, but verify your specific situation with the VA).
...
This is the most important sequencing question in military education planning, and the answer is almost always the same:

**Use Tuition Assistance (TA) while on active duty. Save your GI Bill for after separation.**
...
- A 4-year additional service commitment
- Dependents must be enrolled in DEERS
- Transfer request must be approved before separation (transferability cannot be added post-separation)
...
GI Bill MHA for fully online programs is paid at the national rate ($948.75/month in 2026 for full-time enrollment), not at the school ZIP code rate. This is significantly lower than the BAH-based MHA at most urban schools. If maximizing MHA is a priority, in-person programs at high-BAH locations outperform online programs by a wide margin.
...
The optimal strategy for most service members:
