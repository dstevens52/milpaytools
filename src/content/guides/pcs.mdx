...
**Dislocation Allowance (DLA)** is a flat payment intended to offset the "dislocation" costs of setting up a new household. It is paid once per PCS move.

*2026 DLA rates:*
- Without dependents: $1,883.10
- With dependents: $3,766.20

DLA does not vary by distance, grade, or actual costs. It's a flat payment — you receive it whether you move across town or across the country.

**MALT (Monetary Allowance in Lieu of Transportation)** is the per-mile reimbursement for driving your personal vehicle(s). In 2026, MALT reimburses at **$0.21/mile** for the first POV and **$0.21/mile** for a second POV when dependents are involved. The mileage is calculated based on official DoD distances, not your actual route.

A cross-country move from Virginia to California (~2,700 miles): 2,700 × $0.21 = **$567**. This is meaningfully less than actual fuel and vehicle costs for most families — MALT is a partial reimbursement, not full coverage.

**Per diem** covers lodging and meals during travel. The rate varies by destination and travel day. Per diem is paid for the authorized number of travel days, which is calculated as 1 day per 350 miles of official distance. For the Virginia-to-California move, that's roughly 7-8 authorized travel days.

**Temporary Lodging Expense (TLE)** covers lodging at your old or new duty station while you're between permanent housing. Maximum 10 days at the old location and/or new location combined, reimbursed at actual cost up to the per diem rate for the area.
...
**Taxes:** PPM profit is taxable income. The government will report it, and you should budget for a tax payment in the year of the move.
...
**The smart approach:** Treat OCONUS allowances as a wash against OCONUS costs, not as a windfall. If you're actually spending less than your OHA, send the excess to TSP or savings immediately — don't let lifestyle inflation absorb it. The automatic deployment savings discipline that works well for CONUS deployments applies here too.
