...
slug: pcs
date: "2026-04-12"
description: "Plan your PCS finances with our complete guide. DLA rates, MALT mileage, per diem, TLE, PPM net proceeds, BAH changes, and duty station cost comparison tools."
...
<QuickAnswer>
  ...
  <QAItem>PPM (Personally Procured Move, formerly DITY) lets you keep part of what the government would have paid for a contracted move — net proceeds of $1,000–$8,000 depending on move distance and goods weight</QAItem>
...
## What PCS entitlements are you authorized when you receive orders?
...
<CalculatorCallout calculator="pcs" text="Estimate your total PCS entitlements — DLA, MALT mileage, per diem, TLE, and PPM net proceeds. Uses 2026 DTMO rates." />

## Should you use a government contracted move or do a PPM (DITY move)?
...
**Personally Procured Move (PPM):** You manage your own move — renting a truck, hiring movers, or using a POD container — and the government reimburses you **95% of what it would have cost them** to ship your goods by contracted carrier. This creates a savings opportunity when you can move your household goods for less than what the government would have paid.

**PPM savings calculation:**
...
Net proceeds = Reimbursement − Actual cost

Typical PPM net proceeds on a full household goods move range from $1,000 to $8,000 depending on move distance and actual costs. The biggest variable is how efficiently you move — self-packing and using a rented truck increases net proceeds; hiring a full-service mover and using a shipping container reduces them.

**Taxes:** PPM net proceeds are taxable income. The government will report it — plan for a tax payment in the year of the move.
...
This means:
- Moving from [San Diego](/bah/naval-station-san-diego) to [Fort Bragg](/bah/fort-bragg) could reduce your BAH by $1,000–$2,000/month
...
## How do you compare two duty stations financially before accepting orders?
...
## Why do OCONUS allowances often produce less savings than service members expect?
...
## What is the PCS financial timeline and when should each entitlement be claimed?
...
## How does PCS work differently for dual military couples?
...
**Separation allowance:** Service members who are geographically separated from dependents due to military assignment (not voluntarily) may qualify for a monthly Overseas Housing Allowance differential or, in some cases, a Family Separation Allowance of $300/month.
...
## How can you use your BAH to build wealth through each PCS move?
...
See [How BAH Builds Wealth](/blog/how-bah-builds-wealth) for more on VA home loan strategy.

## Related Articles

- [The PCS That Costs $14,000 — And the One That Makes $6,000](/blog/pcs-that-costs-14000-vs-makes-6000) — Two scenarios for the same E-6 family on the same [Fort Campbell](/bah/fort-campbell) to [JBLM](/bah/joint-base-lewis-mcchord) move — $20,000 apart based purely on knowing the entitlements
- [PCS Financial Planning Guide](/blog/pcs-financial-planning-guide) — Complete checklist: what to do before, during, and after orders drop to protect your finances
- [The $47,000 Gap: Why Two E-5s With the Same Rank Make Wildly Different Money](/blog/the-47000-gap-bah-duty-station) — How BAH creates massive compensation differences across duty stations
