...
- Station data: station-level data files with BAH rates, local market data (median rent, home prices, neighborhoods), branch, installation details
...
- 34 blog posts (MDX)
- 6 guide hub pages at /guides/[name]
- /guides/starting-service — dedicated journey landing page
- /transition — transition hub page
- Homepage with journey cards, 1-2-3 process strip, calculator grid with filter pills
...
- Calculator pages share common patterns: 3-step plan, trust pill badges, static example, disclaimer, post-result email signup
...
- Use "Common among:" not "Best for:" when describing neighborhood demographics
